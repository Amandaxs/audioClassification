...
def get_model(model_name, folder = "./models/" ) -> keras.engine.functional.Functional:
    """"
...
def get_audio(audio_name, audio_folder = 'audios/', add_wav = True) :
    """"
...
def single_split(audio,from_min,to_min, split_filename, filename,save_folder):
    ...
    if get_duration(split_audio) == 10.2:
        ...
        path_complemento = 'ruido_complementar.wav'
